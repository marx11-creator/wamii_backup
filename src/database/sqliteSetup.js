  ...
  txn.executeSql(
    ...
    function (tx, res) {
      if (res.rows.length == 0) {
        ...
        txn.executeSql(
          'CREATE TABLE IF NOT EXISTS tbl_sales_per_customer(user_id INTEGER PRIMARY KEY AUTOINCREMENT, invoice_date VARCHAR(255), account_customer_name VARCHAR(255), invoice_no VARCHAR(255), principal_name VARCHAR(255), sales INT(100), invoice_status VARCHAR(255))',
          [],
        );
      }
    },
